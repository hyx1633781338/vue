    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/cwgl',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/CWGL.vue'),
                    meta: { title: '放款管理' }
                },
                {
                    path: '/zdcs',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/ZDCS.vue'),
                    meta: { title: '账单催收' }
                },
                {
                    path: '/zdcsxq',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/ZDCSXQ.vue'),
                    meta: { title: '催收详情' }
                },
                {
                    path: '/zdsl',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/CDLS.vue'),
                    meta: { title: '账单流水' }
                }
                ,
                {
                    path: '/redirect',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/redirect.vue'),
                    meta: { title: 'wu' }
                }  ,
                {
                    path: '/adminlist',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/AdminList.vue'),
                    meta: { title: '用户信息' }
                }  ,
                {
                    path: '/productlist',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/ProductList.vue'),
                    meta: { title: '产品信息' }
                } ,
                {
                    path: '/jksh',
                    component: () => import(/* webpackChunkName: "donate" */ '../components/page/JKSH.vue'),
                    meta: { title: '借款审核' }
                }
