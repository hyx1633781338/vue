			...
			<div class="handle-box">
				<el-form ref="query" :model="query" label-width="80px">
					...
					<el-select v-model="query.svrStatus" placeholder="请选择" class="handle-select mr10">
						<el-option key="1" label="" value="已归档"></el-option>
					</el-select>
					服务类型
		...
		<el-dialog title="编辑" :visible.sync="editVisible" width="60%">
			<el-form ref="form" :model="form" label-width="80px">
				...
				<el-form-item label="处理结果">
					<el-col :span="10">
						<el-input :disabled="true" v-model="form.svrResult"></el-input>
					</el-col>
					<el-col class="line" :span="4">
						<center>满意度</center>
					</el-col>
					<el-col :span="10">
							 <el-rate :disabled="true" style="margin-top: 5px;" v-model="form.svrSatisfy"></el-rate>
					</el-col>
				</el-form-item>
			</el-form>
