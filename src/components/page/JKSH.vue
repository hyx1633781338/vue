<template>
        ...
        <div class="container" style=" height:500px">
            <div class="handle-box">
                <el-form ref="forma" :model="forma" label-width="70px">
                    <el-select v-model="forma.statea" placeholder="状态" class="handle-select mr10">
            ...
            <el-table :data="tableData" height="400" border class="table" ref="multipleTable"
                ...
                <el-table-column label="状态" align="center" width="120">
                    <template slot-scope="scope">
                        <el-tag :type="scope.row.statea==='审核通过'?'success':(scope.row.statea==='未通过'?'danger':'')">
                            {{scope.row.statea}}
                        </el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="操作" width="280" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" icon="" class="" @click="handleEdita(scope.$index, scope.row)">审核
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    <el-button type="primary" @click="saveEdita('未通过')">否决</el-button>
	 <el-button type="primary" @click="saveEdita('审核通过')">通过审核</el-button>
  </span>
        </el-dialog>
        ...
        <el-dialog :title="dialogTitle" :visible.sync="editVisible" width="40%" @close="handleDialogClose">
            <el-form :model="formb" label-width="70px" :rules="rules" ref="formb" :label-position="labelPosition"
                ...
                <el-form-item label="指派给">
                    <el-col :span="24">
                        <el-form-item prop="admina">
                            <el-select v-model="formb.admina" placeholder="请指派处理人员">
